...
const VisitsPerArea = () => {
    ...
    const fetchStats = async () => {
        let route = `http://localhost:4000/areaStats?`;
        ...
        <div>
              <TableContainer component={Paper}>
                <Table className={classes.table} aria-label="simple table">
                  ...
                  <TableBody>
                    {stats.map((stat) => (
                      <TableRow key={stat.number_of_visits + " " + stat.area_id + " " + stat.area_name}>
                        <TableCell component="th" scope="row">
                          {stat.number_of_visits}
                        </TableCell>
                        <TableCell align="center">{stat.area_id}</TableCell>
                        <TableCell align="center">{stat.area_name}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
