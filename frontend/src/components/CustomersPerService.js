...
const CustomersPerService = () => {
    ...
    const fetchStats = async () => {
        let route = `http://localhost:4000/successfulServiceStats?`;
        ...
        <div>
          <h3
            ...
            style={{ 
              ...
              Find the number of customers using each service:
          </h3>
          <FormControl 
            ...
            >
              <TableContainer component={Paper}>
                <Table className={classes.table} aria-label="simple table">
                  ...
                  <TableBody>
                    {stats.map((stat) => (
                      <TableRow key={stat.number_of_customers + " " + stat.description}>
                        <TableCell component="th" scope="row">
                          {stat.number_of_customers}
                        </TableCell>
